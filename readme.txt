...
Tags: email, transactional, sendwithus, sendgrid, mandrill, mailgun, message bus, postmark
...
After installation make sure to activate the plugin and have your API key handy! sendwithus templates can now be used!

== Frequently Asked Questions ==

### What are the system requirements? ###
The sendwithus plugin requires:

* WordPress 3.9
* A sendwithus account

### What about MultiSite WordPress emails? ###
